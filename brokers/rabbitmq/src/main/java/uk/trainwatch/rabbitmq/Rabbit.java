...
public class Rabbit
{
     ...
     * @param consumer   Event to fire
     */
    public <T> void queueConsumer( String queueName, String routingKey, Map<String, Object> properties,
                                   Function<byte[], T> mapper, Consumer<T> consumer )
    {
     ...
     */
    public <T> void queueConsumer( String queueName, String topic, String routingKey, Function<byte[], T> mapper,
                                   Consumer<T> consumer )
    {
     ...
     * @param consumer   Consumer to fire
     */
    public <T> void queueDurableConsumer( String queueName, String routingKey, Map<String, Object> properties,
                                          Function<byte[], T> mapper, Consumer<T> consumer )
    {
     ...
     * @param consumer   Consumer to fire
     */
    public <T> void queueDurableConsumer( String queueName, String topic, String routingKey, Function<byte[], T> mapper,
                                          Consumer<T> consumer )
    {
     ...
     * @param event      CDI Event to fire
     */
    public <T> void queueDurableEvent( String queueName, String topic, String routingKey, Function<byte[], T> mapper,
                                       Event<T> event )
    {
