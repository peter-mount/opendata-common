...
public class RabbitMQ
{
     ...
     */
    public static <T> void queueEvent( RabbitConnection connection, String queueName, String routingKey,
                                       Function<byte[], T> mapper, Event<T> event )
    {
     ...
     * @param event      CDI Event to fire
     */
    public static <T> void queueDurableEvent( RabbitConnection connection, String queueName, String routingKey,
                                              Function<byte[], T> mapper, Event<T> event )
    {
     ...
     * @param event      CDI Event to fire
     */
    public static <T> void queueDurableEvent( RabbitConnection connection, String queueName, String topic, String routingKey,
                                              Function<byte[], T> mapper,
                                              Event<T> event )
    {
    ...
    public static RabbitConnection createConnection( Configuration config )
    {
